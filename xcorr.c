...
void *xcorr_thread(void *ptr)
{
    ...
    intPubAttrCheck(6, (wxSpeaCalFrame *) ptr, FramesPerBuffer);
    intPubAttrCheck(0, (wxSpeaCalFrame *) ptr, NormTDOA);
    timevalPubStartTimeCheck((wxSpeaCalFrame *) ptr, startTime);
    ...
    {
        usleep(200000);
        shintPubAttrCheck(2, NULL, (wxSpeaCalFrame *) ptr, pubXcorrFileID);
        shintPubAttrCheck(0, pubXcorrFileID, (wxSpeaCalFrame *) ptr, pubXcorrReadyFlag);
        if (pubXcorrReadyFlag == go_flag)
        {
            usleep(1000);
            shintPubAttrBitToggle(1, NULL, (wxSpeaCalFrame *) ptr, 0);
            ...
            for (i=FIRST_MIC_ID; i<=FIRST_MIC_ID+RECORD_THREADS-2; i++)
            {
                ...
                doublePubAttrCheck(8, i-FIRST_MIC_ID, (wxSpeaCalFrame *) ptr, temp);
                ...
                if (temp == 0)
                {
                    ...
                    doublePubAttrAssign(8, i-FIRST_MIC_ID, (wxSpeaCalFrame *) ptr, maxTemp1);
                    fprintf(stdout, "temp[%d] = %f\n", i-FIRST_MIC_ID, maxTemp1);
                ...
                for (j = 1; j <= FIRST_MIC_ID+RECORD_THREADS-i-1; j++)
                {
                    ...
                    doublePubAttrCheck(8, i+j-FIRST_MIC_ID, (wxSpeaCalFrame *) ptr, temp);
                    ...
                    if (temp == 0)
                    {
                        ...
                        doublePubAttrAssign(8, i+j-FIRST_MIC_ID, (wxSpeaCalFrame *) ptr, maxTemp2);
                        fprintf(stdout, "temp[%d] = %f\n", i+j-FIRST_MIC_ID, maxTemp2);
                        //fprintf(stdout, "cari max %d!\n", i+j-FIRST_MIC_ID);
                    ...
                    if (temp1 & 1 && temp2 & 1)
                    {
                        if(!NormTDOA)
                        {
                            ...
                            TimevalDiff(&timeDiff, &currTime, &startTime, (wxSpeaCalFrame *) dummy);
                            ...
                            doublePubAttrAssign(4, k, (wxSpeaCalFrame *) ptr, tdoa_msec);
                            //doublePubAttrAssign(9, k, (wxSpeaCalFrame *) ptr,
                            //                    sqrt(meanTemp1/FramesPerBuffer)/sqrt(meanTemp2/FramesPerBuffer));
                            doublePubAttrAssign(12, k, (wxSpeaCalFrame *) ptr,
                        ...
                        else
                        {
                            ...
                            doublePubAttrCheck(11, i - FIRST_MIC_ID, (wxSpeaCalFrame *) ptr,
                                                   pubDevRecordStartTime1);
                            doublePubAttrCheck(11, (i+j) - FIRST_MIC_ID, (wxSpeaCalFrame *) ptr,
                                                   pubDevRecordStartTime2);
                            doublePubAttrCheck(3, i - FIRST_MIC_ID, (wxSpeaCalFrame *) ptr,
                                                   pubDevXcorrReadyTime1);
                            doublePubAttrCheck(3, (i+j) - FIRST_MIC_ID, (wxSpeaCalFrame *) ptr,
                            ...
                            doublePubAttrAssign(7, k, (wxSpeaCalFrame *) ptr, tdoa_msec);
                            //doublePubAttrAssign(10, k, (wxSpeaCalFrame *) ptr,
                            //                    sqrt(meanTemp1/FramesPerBuffer)/sqrt(meanTemp2/FramesPerBuffer));
                            doublePubAttrAssign(13, k, (wxSpeaCalFrame *) ptr,
                                                (maxTemp1-minTemp1)/(maxTemp2-minTemp2));
            ...
            if (done == 0)
            {
                gettimeofday(&currTime, NULL);
                TimevalDiff(&timeDiff, &currTime, &startTime, (wxSpeaCalFrame *) dummy);
                doublePubAttrAssign(5, 0, (wxSpeaCalFrame *) ptr,
                                    timeDiff.tv_sec + (double) timeDiff.tv_usec/1000000);
                doublePubAttrAssign(0, pubXcorrFileID, (wxSpeaCalFrame *) ptr, 0);
                shintPubAttrBitToggle(2, NULL, (wxSpeaCalFrame *) ptr, 0);

                for (i=FIRST_MIC_ID; i<FIRST_MIC_ID+RECORD_THREADS; i++)
                {
                    doublePubAttrAssign(8, i-FIRST_MIC_ID, (wxSpeaCalFrame *) ptr, 0);
                }
            }
        }
    }
